...
const SelPage = () => {
    ...
    useEffect(()=>{
        fetch(`https://16.171.129.175/question/singel/verify/data/01/sakhd/${username}`)
        .then(res => res.json())
        .then(data => setUpii2(data))

        fetch(`https://16.171.129.175/question/singel/verify/data/01/sakhd/sjkh/dsf/dfsd/${username}`)
        .then(res => res.json())
    ...
    if(Qno === "1"){
        if(upii2.qno1 === "false"){
            ...
            axios.delete(`https://13.51.85.151/delete/data/api/dont/know/ada/upi/${one}`)
            .then(res =>{
                if(res.data.Status === "OK"){
                    axios.delete(`https://13.51.85.151/delete/data/api/dont/know/ada/upi/one/exts/${two}`)
                    .then(res =>{
                    if(res.data.Status === "OK"){
