...
const Question = () => {
  ...
  const [upii1 , setUpii1] = useState([]);
    ...
    if(seconds === 0){
      axios.delete(`https://16.170.242.41/delete/data/api/dont/know/ada/upi/${upii1._id}`)
        .then(res =>{
          if(res.data.Status === "OK"){
            axios.delete(`https://16.170.242.41/delete/data/api/dont/know/ada/upi/one/exts/${upii2._id}`)
            .then(res =>{
              if(res.data.Status === "OK"){
                alert("Time Out")
  ...
  useEffect(()=>{
    axios.post("https://16.170.242.41/verify/account/key",{username})
    .then(res =>{
      if(res.data.Status === "OK"){
        ...
        fetch(`https://16.170.242.41/question/singel/verify/data/01/${username}`)
        .then(res => res.json())
        .then(data => setVerrii(data))

    if(qno !== null){
      fetch(`https://16.170.242.41/question/singel/01/${qno}`)
      .then(res => res.json())
      .then(data => setData(data));
    }
    fetch(`https://16.170.242.41/question/singel/verify/data/01/sakhd/sjkh/dsf/dfsd/${username}`)
    .then(res => res.json())
    .then(data => setUpii1(data))

    fetch(`https://16.170.242.41/question/singel/verify/data/01/sakhd/${username}`)
    .then(res => res.json())
  ...
  const Button1 = () =>{
    resetTimer();
    const Option  = "A"
    axios.post("https://16.170.242.41/answer/check/question/correct/or/wrong",{Option, noq, Qno, username})
    .then(res =>{
      if(res.data.Status === "OK"){
        ...
        axios.delete(`https://16.170.219.193/delete/data/api/dont/know/ada/upi/${upii1._id}`)
        .then(res =>{
          if(res.data.Status === "OK"){
            axios.delete(`https://16.170.219.193/delete/data/api/dont/know/ada/upi/one/exts/${upii2._id}`)
            .then(res =>{
              if(res.data.Status === "OK"){
